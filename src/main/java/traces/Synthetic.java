...
public final class Synthetic {
    ...
    public static TraceReader.KeyOnlyTraceReader generate(BasicSettings settings) {
     ...
     */
    public static LongStream counter(int start, long events) {
     ...
     * @param events the number of events in the distribution
     */
    public static LongStream exponential(double mean, long events) {
     ...
     * @param events the number of events in the distribution
     */
    public static LongStream scrambledZipfian(long items, double constant, long events) {
     ...
     * @param events the number of events in the distribution
     */
    public static LongStream skewedZipfianLatest(long items, long events) {
     ...
     * @param events the number of events in the distribution
     */
    public static LongStream zipfian(long items, double constant, long events) {
     ...
     */
    public static LongStream uniform(int lowerBound, int upperBound, long events) {
